    ...
    <section id="experience" className="section-padding relative z-30">
      <div ref={setRef} className="relative z-10">
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-12 text-center text-white">Experience</h2>
        </div>
          ...
          {experiences.map((exp, i) => (
            <div 
              ...
              className={`transition-all duration-1000 ease-out ${
                isVisible 
                  ? `opacity-100 translate-x-0 translate-y-0` 
                  : `opacity-0 ${i === 0 ? '-translate-x-[100vw]' : 'translate-x-[100vw]'} translate-y-8`
              } ${
                i === 0 ? 'w-full md:w-1/2 md:pr-4' : 'w-full md:w-1/2 md:ml-auto md:pl-4 md:mt-8'
              }`}
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-lg p-6 rounded-xl border-2 border-purple-500/50 shadow-lg shadow-purple-500/20">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-lg md:text-xl text-gray-400">{exp.date}</span>
                </div>
                <p className="text-lg md:text-xl text-gray-300">{exp.company}</p>
                <ul className="list-disc list-inside text-base md:text-lg text-gray-300 mt-2">
